...
class SunriseAndSunsetControllerTest {
  ...
  void testGetSunriseAndSunsetInfo_ExistingCoordinatesExistingDate() {
    ...
    Mockito.verify(coordinatesRepositoryService, Mockito.times(1)).save(Mockito.any(Coordinates.class));
...
//  }
  ...
  @Test
  void testGetCoordinatesByCountry() throws IllegalAccessException {
    // Подготовка
    String countryName = "TestCountry";
    String date = "2023-04-01";
    ...
    // Выполнение
    String result = controller.getCoordinatesByCountry(countryName, date);
